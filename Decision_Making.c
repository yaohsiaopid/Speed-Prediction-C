...
int main()
{
    ...
    const int Speed=Velocity[1];
    int i, j;
    float tmpVal;
    // line 50 init A,B,C,D
    float A[TotalNe], B[TotalNe], C[TotalNe], D[TotalNe], Ibias[TotalNe], ExternalI[TotalNe] = {0}, Inoise[TotalNe], v[TotalNe], u[TotalNe], S1[TotalNe] = {0}, S2[TotalNe] = {0}, Potential[TotalNe+1] = {0}, SynapticCurrent1[TotalNe+1] = {0}, SynapticCurrent2[TotalNe+2] = {0};
