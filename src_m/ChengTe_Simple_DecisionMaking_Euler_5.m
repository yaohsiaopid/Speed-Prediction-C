...
for l=1:1
	...
	for t=1:SimulationTime/DeltaT        % simulation time ms
        ...
        fptr = fopen("./matlabout/t" + t + ".txt", 'w');
        fprintf(fptr, "ExternalI = ");
        fprintf(fptr, '%3.4f ', ExternalI);
        fprintf(fptr, '\n');
  
        fprintf(fptr, "before u = ");
        fprintf(fptr, '%3.4f ', u);
        fprintf(fptr, '\n');
        fprintf(fptr, "before v = ");
        fprintf(fptr, '%3.4f ', v);
        fprintf(fptr, '\n');
        ...
        fprintf(fptr, "Ibias = ");
        fprintf(fptr, '%3.4f ', Ibias);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fa1 = ");
        fprintf(fptr, '%3.4f ', fa1);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fa2 = ");
        fprintf(fptr, '%3.4f ', fa2);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fa3 = ");
        fprintf(fptr, '%3.4f ', fa3);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fa4 = ");
        fprintf(fptr, '%3.4f ', fa4);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fb1 = ");
        fprintf(fptr, '%3.4f ', fb1);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fb2 = ");
        fprintf(fptr, '%3.4f ', fb2);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fb3 = ");
        fprintf(fptr, '%3.4f ', fb3);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "fb4 = ");
        fprintf(fptr, '%3.4f ', fb4);
        fprintf(fptr, '\n');
        ...
        fprintf(fptr, "S1 = ");
        fprintf(fptr, '%3.4f ', S1);
        fprintf(fptr, '\n');
        
        fprintf(fptr, "S2 = ");
        fprintf(fptr, '%3.4f ', S2);
        fprintf(fptr, '\n');
